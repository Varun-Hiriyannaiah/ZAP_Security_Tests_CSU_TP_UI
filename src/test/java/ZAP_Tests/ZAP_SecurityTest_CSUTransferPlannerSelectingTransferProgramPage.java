...
public class ZAP_SecurityTest_CSUTransferPlannerSelectingTransferProgramPage {
    ...
    public void LivingProfileSecurityTest() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//button[contains(text(),'Program Details')]")).click();
    ...
    public void tearDown() {
        if (api != null) {
            ...
            String title = "CSU Transfer Planner Selecting Transfer Programs Security Test Report";

            String template = "traditional-html";

            String description = "CSU Transfer Planner Selecting Transfer Programs Page Security Test Report";

            String reportfilename = "CSU_TransferPlannerSelectingTransferPrograms.html";
            ...
            try {
                ...
                System.out.println("CSU Transfer Planner Selecting Transfer Programs Security Test Report" + response.toString());
