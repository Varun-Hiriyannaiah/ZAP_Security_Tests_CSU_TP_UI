...
public class ZAP_SecurityTest_AcademicGoalsPage {
    ...
    public void LivingProfileSecurityTest() throws InterruptedException {
        ...
        try {
            new WebDriverWait(driver,  Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//h6[contains(text(),'Academic Goals')]")));
            System.out.println("Element is clickable");
        }
        catch(TimeoutException e) {
            System.out.println("Element isn't clickable");
        ...
        driver.findElement(By.xpath("//h6[contains(text(),'Academic Goals')]")).click();

        driver.findElement(By.xpath("//h1[contains(text(),'Academic Goals')]")).isDisplayed();
        ...
        driver.findElement(By.xpath("//label[contains(text(),'Target Start Date')]")).isDisplayed();
        ...
        driver.findElement(By.xpath("//input[@id='year_startDate']")).sendKeys("2020");
    ...
    public void tearDown(){
        if (api!= null){
            ...
            String title = "Living Profile Academic Goals page Security Test Report";

            String template = "traditional-html";
            
            String description = "Living Profile Academic Goals Security Test Report";
            
            String reportfilename = "LivinfProfileAG.html";
